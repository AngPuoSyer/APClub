    ...
    >
      <slot name="left">
        <div class="flex flex-col">
          ...
          <h1 class="text-3xl font-black mt-3">APClub Super Admin Panel</h1>
          <h2 class="container-sub">Manage Clubs Easily for SRC</h2>
        </div>
      </slot>
    </div>
...
const loginEmit = defineEmits<{ (e: "loginEvent", payload: LoginPayload) }>();
</script>
